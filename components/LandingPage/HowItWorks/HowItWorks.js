...
const steps = [
	...
	},
	{
		...
		details:
			"Προώθησέ μας τον κατάλογο με τα προϊόντα της επιχείρισής σου σε μορφή doc, docx ή pdf και εμείς θα φροντίσουμε ο ηλεκτρονικός σου κατάλογος να είναι διαθέσιμος όσο το δυνατόν γρηγορότερα!",
	},
];
